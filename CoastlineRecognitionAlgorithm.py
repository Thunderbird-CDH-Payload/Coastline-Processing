...
# Read Image
img = cv2.imread('/Users/curtishuebner/documents/development/CDHImageProccessing/Coastline/SpaceCoastFromSpaceStation.jpg')
...
gaussianBlurredImage = colorFilteredImg     

## Canny Edge Detector
# Compute the Canny filter for two values of sigma
edges1 = feature.canny(gaussianBlurredImage)
edges2 = feature.canny(gaussianBlurredImage, sigma=2)
edges3 = feature.canny(gaussianBlurredImage, sigma=3)
...
img1.imshow(colorFilteredImg, cmap=plt.cm.gray)
img1.axis('off')
